...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference("Sector.count") do
      post sectors_url, params: { sector: { department_id: @sector.department_id, description: @sector.description } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { department_id: @sector.department_id, description: @sector.description } }
