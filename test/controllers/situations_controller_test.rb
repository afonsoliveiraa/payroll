...
class SituationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create situation" do
    assert_difference("Situation.count") do
      post situations_url, params: { situation: { active: @situation.active, description: @situation.description } }
    end
  ...
  test "should update situation" do
    patch situation_url(@situation), params: { situation: { active: @situation.active, description: @situation.description } }
